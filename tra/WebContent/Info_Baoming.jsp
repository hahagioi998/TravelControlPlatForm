...
List<Info> infos=userDao.find_infos(loginUser.getUsername());
...
<div style="height:300px">
   ...
   <div style="margin-top:20px;"> 
        <table class="layui-table" style="width:1000px">
			<thead>
			<tr>
			<th style="font-size:25px;text-align:center;">姓名</th>
			<th style="font-size:25px;text-align:center;">报名类型</th>
			<th style="font-size:25px;text-align:center;">报名电话</th>
			<th style="font-size:25px;text-align:center;">景点</th>
			<th style="font-size:25px;text-align:center;">状态</th>
			<th style="font-size:25px;text-align:center;">人数</th>
			<th style="font-size:25px;text-align:center;">班级</th>
...
<%
		...
		<tr>
			...
			<td style="font-size:25px;text-align:center;"> <%=info.getU_Name() %></td>
			<td style="font-size:25px;text-align:center;"> <%=info.getU_Type()%></td>
			<td style="font-size:25px;text-align:center;"> <%=info.getTelephone() %></td>
			<td style="font-size:25px;text-align:center;"> <%=info.getPlace() %></td>
			<td style="font-size:25px;text-align:center;"> <%=info.getStatus() %></td>
			<td style="font-size:25px;text-align:center;"> <%=info.getNumber() %></td>
			<td style="font-size:25px;text-align:center;"> <%=info.getClass1() %></td>
