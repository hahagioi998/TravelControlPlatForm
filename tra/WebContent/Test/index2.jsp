...
function panduan(id)
{
	  ...
	  alert(tit); */
	  if(num==0){
		  layer.confirm('你还未登录，无法留言，请先去登录', {icon: 6, title:'提示'}, function(index){
...
<div class="light"  id="light" style="margin-top:-180px;height:500px;width:500px;margin-left:180px;display: block;">
...
<div id="fade" style="display: block; height:2610px">
</div>
...
<section class="container home-content" style="margin-top:-20px;background-color: #f1f2f3;width:2000px">
 ...
 <p />
	...
	<div class="clear"></div>
		...
		<a class="portfolio-item" href="https://baike.baidu.com/item/%E5%A4%A9%E6%B4%A5/132308?fr=aladdin">
...
return false;
	...
	<script src="js1/jquery.desoslide.js"></script>
	<script>
