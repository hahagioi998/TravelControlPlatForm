...
<head>
  ...
  ================================================== -->
	<meta charset="utf-8" />
	<title>Portfolio Item - Vincie.web</title>
...
<div id="wrap" style="height:1950px">
...
<div id="slide-container">
		<div id="example"  style="margin-left:200px">
		<div id="frame"></div>
			<div id="slides" >
				<div class="slides_container">
					<div class="slide" style="width:600px;height：500px">
					
						 <embed src="travel.mp4" type="audio/mpeg" width="775" height="585" style="margin-left:-100px" ></embed>

						<div class="caption" style="width:600px;margin-left:500px">
...
<div class="clear" ></div>
<div class="eight columns" style="margin-top:300px">
<h4 class="subtitle">服务介绍</h4>
<div class="block-q1" style="height:200px;margin-left:50px">
<p><img src="images/quote-ico1.png" /></p>
<p>学校+同学+景点=石小铁旅游网？
<br />
...
<div class="eight columns" style="margin-left:-120px;margin-top:420px">

<h4>我们的服务：</h4>
<p>该服务平台产品全面，价格透明，可以更好地帮助游客了解目的地信息，妥善制定好出游计划，并方便地预订旅程中的服务项目，并提供丰富的后续服务和保障线轻松预订，专属客服24小时快速反应，更有牛到家服务，足不出户，服务到家
量身定制：专业旅游顾问团，丰富的产品线，满足您量身定制的个性化需求。
</p>
</div>
...
<div class="white-space"></div>
	...
	<footer id="footer" align="center" style="margin-top:-150px">
		...
		<hr/>
		<div class="subscribe-grid text-center" style="height:156px;margin-top:-50px">
